...
<head>
    ...
    <title>Heritage Rajshahi Silk</title>
    <meta name="keywords" content="HTML5 Template">
    <meta name="description" content="Heritage Rajshahi Silk">
            ...
            <div class="container">
                <div class="header-left">
                    ...
                    <a href="{{url('/home')}}" class="logo">
                        <img src="assets/images/demos/demo-18/logo.png" alt="HRS logo" width="105" height="25">
                    </a>
                    ...
                    <nav class="main-nav">
                        <ul class="menu sf-arrows">
                            ...
                            <li>
                                <a href="productCategory" class="sf-with-ul">Shop</a>


                            </li>
                            <li>
                                <a href="productCategory" class="sf-with-ul">Product</a>
                            </li>
                    ...
                    <div class="dropdown cart-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <div class="product">
                                    ...
                                    <figure class="product-image-container">
                                        <a href="product.html" class="product-image">
                                            <img src="categorypic/{{$product['product_image1']}}" alt="product">
                                        </a>
                                    </figure>
                                    <a href="#" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                </div><!-- End .product -->
                            ...
                            <div class="dropdown-cart-total">
                                ...
                                <span class="cart-total-price">{{$product->product_price}}</span>
                            </div><!-- End .dropdown-cart-total -->

                            <div class="dropdown-cart-action">
                                <a href="/cart/{{$product->id}}" class="btn btn-primary">View Cart</a>
                                ...
                                <div class="row">
                                    <figure class="product-main-image">
                                        <img src="categorypic/{{$product['product_image1']}}"
                                             data-zoom-image="categorypic/{{$product['product_image1']}}"
                                             alt="product image">
                                    ...
                                    <div id="product-zoom-gallery" class="product-image-gallery">
                                        <a class="product-gallery-item active" href="#"
                                           data-image="categorypic/{{$product['product_image2']}}"
                                           data-zoom-image="assets/images/products/single/centered/1-big.jpg">
                                            <img src="categorypic/{{$product['product_image2']}}" alt="product image">
                                        </a>

                                        <a class="product-gallery-item" href="#"
                                           data-image="categorypic/{{$product['product_image1']}}"
                                           data-zoom-image="assets/images/products/single/centered/2-big.jpg">
                                            <img src="categorypic/{{$product['product_image1']}}" alt="product cross">
                                        </a>
                                ...
                                <div class="product-details-action">
                                    <div class="details-action-col">
                                        ...
                                        <a href="/cart{{$product->id}}"
                                           class="btn-product btn-cart"><span>Procced to Checkout</span></a>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="product-desc-tab" role="tabpanel"
                            ...
                            <div class="product-desc-content">
                                ...
                                <p>{{$product->description}} </p>
                                <ul>
                                    <li>{{$product->sarees}}.</li>

                                </ul>

                                <p>The saree is very soft and easy to wear.The silk of Rajshahi means more value in
                                    cloth all over the country. Although expensive, Bengali brides are at the top of the
                                    list, so keep in mind the price and demand, we are bringing the traditional Rajshahi
                                    silk at a reasonable price. </p>
                        ...
                        <div class="tab-pane fade" id="product-info-tab" role="tabpanel"
                            ...
                            <div class="product-desc-content">
                                ...
                                <ul>
                                    <li>Silk fabric</li>
                                    <li>Product type : {{$product->sarees}}</li>
                        ...
                        <div class="tab-pane fade" id="product-shipping-tab" role="tabpanel"
                            ...
                            <div class="product-desc-content">
                                ...
                                <p>We deliver to all over the country. For full details of the delivery
                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-3">
                        <div class="widget widget-about">
                            <img src="assets/images/demos/demo-18/logo-black.png" class="footer-logo" alt="Footer Logo"
                                 width="124" height="35">
