    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-info mini-stat text-white">
                <div class="p-3 mini-stat-desc">
                    <div class="clearfix">
                        <h6 class="text-uppercase mt-0 float-left text-white-50">Total Product</h6>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-pink mini-stat text-white">
                <div class="p-3 mini-stat-desc">
                    <div class="clearfix">
                        <h6 class="text-uppercase mt-0 float-left text-white-50">Product Category</h6>
                        <h4 class="mb-3 mt-0 float-right">{{$count = \App\Product::all()->count()}}</h4>
                    </div>
                    <div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center">
                        ...
                        <h5 class="font-16"><a href="#" class="text-dark">Heritage Rajshahi Silk - <br><span
