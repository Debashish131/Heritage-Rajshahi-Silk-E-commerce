...
<head>
    ...
    <title>Admin Panel of HRS</title>
    ...
    <link href="{{"assets2"}}/css/bootstrapblack.min.css" rel="stylesheet" type="text/css">
    <link href="{{"assets2"}}/css/iconsblack.css" rel="stylesheet" type="text/css">
    <link href="{{"assets2"}}/css/styleblack.css" rel="stylesheet" type="text/css">
    ...
    <div class="left side-menu">
        ...
        <div class="left-side-logo d-block d-lg-none">
            <div class="text-center">
                <a href="/" class="logo"><img src="assets2/images/logo.png" height="100" width="100" alt="logo"></a>
            </div>
        </div>
                ...
                <ul>
                    ...
                    <li>
                        <a href="{{url('/productdetails')}}" class="waves-effect"><i
                                class="fas fa-car"></i><span> Product Details </span>
                        </a>
                    </li>
                    <li>
        ...
        <div class="content">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left	d-none d-lg-block">
                    <div class="text-center">
                        <a href="{{url('/dashboard')}}" class="logo"><img src="assets2/images/logo.png" height="50"
                                                                          alt="logo"></a>
                    </div>
                </div>
