            ...
            <div class="container">
                <div class="header-left">
                    ...
                    <a href="index.html" class="logo">
                        <img src="assets/images/demos/demo-18/logo.png" alt="HRS" width="105" height="25">
                    </a>
                    ...
                    <div class="dropdown cart-dropdown">
                        <a href="#" class="dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true"
                           aria-expanded="false" data-display="static">
                            ...
                            <span class="cart-count">{{$count = \App\Cart::where([['creator', '=', Auth::user()->name]])->count()}}</span>
                        </a>
                        ...
                        <div class="toolbox">
                            <div class="toolbox-left">
                                <div class="toolbox-info">
                                    Showing <span>{{$count = \App\Product::all()->count()}} of  {{$count = \App\Product::all()->count()}}</span> Products
                                        ...
                                        <div class="product product-7 text-center">
                                            <figure class="product-media">
                                                <a href="/showproduct{{$val->id}}">
                                                    <img src="categorypic/{{$val['product_image1']}}"
                                                         alt="Product image"
                                                         class="product-image">
                                                </a>
