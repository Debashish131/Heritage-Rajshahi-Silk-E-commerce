                        ...
                        <div class="container">
                            <div class="header-left">
                                ...
                                <a href="{{url('/home')}}" class="logo">
                                    <img src="assets/images/demos/demo-18/logo-black.png" alt="HRS logo" width="105"
                                         height="25">
                                </a>
                                            ...
                                            <div class="product">
                                                    ...
                                                    <div class="product-cart-details">
                                                        <h4 class="product-title">
                                                            <a href="product.html">{{$val->product_id}}</a>
                                                        </h4>

                                                        <span class="cart-product-info">
                                                <span class="cart-product-qty">{{$val->quantity}}</span>
                                                x {{$val->price}} = {{$val->price*$val->quantity}}
                                            </span>
...
{{--                                            <span class="cart-total-price">{{$val->product_id}}</span>--}}
                        ...
                        <div class="col-lg-9">
                            <table class="table table-cart table-mobile">
                                ...
                                <tr>
                                    ...
                                    <td class="price-col">{{$product->product_price}} tk</td>
                                    ...
                                    <td class="total-col">{{$product->product_price}} tk</td>
                                    <td class="remove-col">
                            ...
                            <div class="summary summary-cart">
                                ...
                                <table class="table table-summary">
                                    ...
                                    <tr class="summary-shipping-row">
                                        ...
                                        <td>{{$product->product_price+50}} tk</td>
                                    ...
                                    <tr class="summary-shipping-row">
                                        ...
                                        <td>{{$product->product_price+100}} tk</td>
                                    </tr><!-- End .summary-shipping-row -->
                                    ...
                                    <tr class="summary-shipping-row">
                                        ...
                                        <td>{{$product->product_price+150}} tk</td>
                                    </tr><!-- End .summary-shipping-row -->
                                ...
                                <a href="/example2" class="btn btn-outline-primary-2 btn-order btn-block">PROCEED TO
                                    CHECKOUT</a>
                            </div><!-- End .summary -->
