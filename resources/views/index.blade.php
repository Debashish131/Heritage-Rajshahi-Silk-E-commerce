                                ...
                                <div class="col-6 col-md-4">
                                    <div class="product product-4">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="categorypic/{{$val['product_image1']}}" alt="No image" class="product-image" width="277px" height="377px">
{{--                                                <img src="categorypic/{{$val['product_image2']}}" alt="No image found" class="product-image-hover" width="277px" height="377px">--}}
                                            </a>
                                            ...
                                            <div class="product-action">
                                                <a href="{{url('/addToCart')}}" class="btn-product btn-cart"><span>add to cart</span></a>
                                            </div><!-- End .product-action -->
                                            </form>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h3 class="product-title"><a href="product.html">{{$val->product_name}}</a></h3><!-- End .product-title -->
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-3">
                            <div class="widget widget-about">
                                <img src="assets/images/demos/demo-18/logo-footer.png" class="footer-logo" alt="Footer Logo" width="124" height="35">
